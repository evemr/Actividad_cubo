...
public class Actividad_cubo extends GLJPanel implements GLEventListener, KeyListener {
   ...
   public static void main(String[] args) {
      ...
      SwingUtilities.invokeLater(new Runnable() {
         ...
         public void run() {
            ...
            GLJPanel canvas = new Actividad_cubo();
   ...
   public void init(GLAutoDrawable drawable) {
      ...
      this.textura1 = this.cargarTextura("imagenes/pandita.jpg");
